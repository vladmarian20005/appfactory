...
enum AppBrand {
    static let brand = Brand(
        ...
        canvas: .mesh([
            Color(light: 0x14394A, dark: 0x0A2733),
            Color(light: 0x123745, dark: 0x08222D),
            Color(light: 0x16404E, dark: 0x0B2A37),
            Color(light: 0x0E3340, dark: 0x071F29),
            Color(light: 0x114150, dark: 0x0A2B38),
            Color(light: 0x0D303D, dark: 0x061A23),
            Color(light: 0x0B2C38, dark: 0x051821),
            // Bottom centre is the lantern on the water: the one warm point in the dark, so
            // the pool is lit from somewhere rather than simply being dark.
            Color(light: 0x1A4A4A, dark: 0x163731),
            Color(light: 0x0A2A35, dark: 0x04151C),
        ])
    )
